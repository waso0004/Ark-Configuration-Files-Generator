...
const translations = {
    en: {
        ...
        sectionBasic: '🖥️ Basic Server Settings',
        sectionAdmin: '🔐 Admin & Security',
        sectionChat: '💬 Chat & Communication',
        sectionGameplay: '🎮 Gameplay Options',
        ...
        sectionRagnarok: '🌋 Ragnarok-Specific',
        sectionValguero: '🏔️ Valguero-Specific',
        sectionFjordur: '❄️ Fjordur-Specific',
        sectionGenesis: '🌐 Genesis-Specific',
        sectionAberration: '🌌 Aberration-Specific',
        sectionExtinction: '🌍 Extinction-Specific',
        sectionLostColony: '🚀 Lost Colony-Specific',
        
        // Section titles (Lost Colony subsections)
        sectionLCBunker: '🏰 Tek Bunker',
        sectionLCCryoHospital: '❄️ CryoHospital',
        sectionLCBloodforge: '🩸 Bloodforge',
        sectionLCOutpost: '🏕️ Outpost',
        sectionLCCreatures: '🦎 Creatures',
        
        // Section titles (Game.ini)
        sectionGameTaming: '🦖 Taming Settings',
        sectionGamePlayer: '🧑 Player & Leveling',
        sectionGameTribe: '👥 Tribe Settings',
        sectionGameCrafting: '🔨 Crafting & Engrams',
        sectionGameLoot: '🎁 Loot & Resources',
        sectionGameStructures: '🏠 Structures & Building',
        sectionGameTurrets: '🔫 Turrets & Generators',
        sectionGamePvP: '⚔️ PvP Settings',
        sectionGameGenesis: '🌐 Genesis Specific',
        sectionGameEnvironment: '🌡️ Environment & World',
        sectionGameAdvanced: '⚙️ Advanced Configuration',
    ...
    es: {
        ...
        // Section titles (GameUserSettings.ini)
        sectionBasic: '🖥️ Ajustes Básicos del Servidor',
        sectionAdmin: '🔐 Admin y Seguridad',
        sectionChat: '💬 Chat y Comunicación',
        sectionGameplay: '🎮 Opciones de Juego',
        ...
        sectionRagnarok: '🌋 Específico de Ragnarok',
        sectionValguero: '🏔️ Específico de Valguero',
        sectionFjordur: '❄️ Específico de Fjordur',
        sectionGenesis: '🌐 Específico de Genesis',
        sectionAberration: '🌌 Específico de Aberration',
        sectionExtinction: '🌍 Específico de Extinction',
        sectionLostColony: '🚀 Específico de Lost Colony',
        ...
        sectionLCCreatures: '🦎 Criaturas',
        
        // Section titles (Game.ini)
        sectionGameTaming: '🦖 Ajustes de Domesticación',
        sectionGamePlayer: '🧑 Jugador y Subida de Nivel',
        sectionGameTribe: '👥 Ajustes de Tribu',
        sectionGameCrafting: '🔨 Fabricación y Engramas',
        sectionGameLoot: '🎁 Botín y Recursos',
        sectionGameStructures: '🏠 Estructuras y Construcción',
        sectionGameTurrets: '🔫 Torretas y Generadores',
        sectionGamePvP: '⚔️ Ajustes PvP',
        sectionGameGenesis: '🌐 Específico de Genesis',
        sectionGameEnvironment: '🌡️ Entorno y Mundo',
        sectionGameAdvanced: '⚙️ Configuración Avanzada',
    ...
    fr: {
        ...
        // Section titles (GameUserSettings.ini)
        sectionBasic: '🖥️ Paramètres de Base du Serveur',
        sectionAdmin: '🔐 Admin et Sécurité',
        sectionChat: '💬 Chat et Communication',
        sectionGameplay: '🎮 Options de Jeu',
        ...
        sectionRagnarok: '🌋 Spécifique à Ragnarok',
        sectionValguero: '🏔️ Spécifique à Valguero',
        sectionFjordur: '❄️ Spécifique à Fjordur',
        sectionGenesis: '🌐 Spécifique à Genesis',
        sectionAberration: '🌌 Spécifique à Aberration',
        sectionExtinction: '🌍 Spécifique à Extinction',
        sectionLostColony: '🚀 Spécifique à Lost Colony',
        
        // Section titles (Lost Colony subsections)
        sectionLCBunker: '🏰 Bunker Tek',
        sectionLCCryoHospital: '❄️ CryoHospital',
        sectionLCBloodforge: '🩸 Bloodforge',
        sectionLCOutpost: '🏕️ Avant-poste',
        sectionLCCreatures: '🦎 Créatures',
        
        // Section titles (Game.ini)
        sectionGameTaming: '🦖 Paramètres de Domestication',
        sectionGamePlayer: '🧑 Joueur et Progression',
        sectionGameTribe: '👥 Paramètres de Tribu',
        sectionGameCrafting: '🔨 Fabrication et Engrammes',
        sectionGameLoot: '🎁 Butin et Ressources',
        sectionGameStructures: '🏠 Structures et Construction',
        sectionGameTurrets: '🔫 Tourelles et Générateurs',
        sectionGamePvP: '⚔️ Paramètres PvP',
        sectionGameGenesis: '🌐 Spécifique à Genesis',
        sectionGameEnvironment: '🌡️ Environnement et Monde',
        sectionGameAdvanced: '⚙️ Configuration Avancée',
    ...
    de: {
        ...
        // Section titles (GameUserSettings.ini)
        sectionBasic: '🖥️ Grundlegende Server-Einstellungen',
        sectionAdmin: '🔐 Admin & Sicherheit',
        sectionChat: '💬 Chat & Kommunikation',
        sectionGameplay: '🎮 Spieloptionen',
        ...
        sectionRagnarok: '🌋 Ragnarok-Spezifisch',
        sectionValguero: '🏔️ Valguero-Spezifisch',
        sectionFjordur: '❄️ Fjordur-Spezifisch',
        sectionGenesis: '🌐 Genesis-Spezifisch',
        sectionAberration: '🌌 Aberration-Spezifisch',
        sectionExtinction: '🌍 Extinction-Spezifisch',
        sectionLostColony: '🚀 Lost Colony-Spezifisch',
        
        // Section titles (Lost Colony subsections)
        sectionLCBunker: '🏰 Tek-Bunker',
        sectionLCCryoHospital: '❄️ CryoHospital',
        sectionLCBloodforge: '🩸 Bloodforge',
        sectionLCOutpost: '🏕️ Außenposten',
        sectionLCCreatures: '🦎 Kreaturen',
        
        // Section titles (Game.ini)
        sectionGameTaming: '🦖 Zähm-Einstellungen',
        sectionGamePlayer: '🧑 Spieler & Aufstieg',
        sectionGameTribe: '👥 Stammes-Einstellungen',
        sectionGameCrafting: '🔨 Herstellung & Engramme',
        sectionGameLoot: '🎁 Beute & Ressourcen',
        sectionGameStructures: '🏠 Strukturen & Bauen',
        sectionGameTurrets: '🔫 Geschütze & Generatoren',
        sectionGamePvP: '⚔️ PvP-Einstellungen',
        sectionGameGenesis: '🌐 Genesis Spezifisch',
        sectionGameEnvironment: '🌡️ Umgebung & Welt',
        sectionGameAdvanced: '⚙️ Erweiterte Konfiguration',
    ...
    pt: {
        ...
        // Section titles (GameUserSettings.ini)
        sectionBasic: '🖥️ Configurações Básicas do Servidor',
        sectionAdmin: '🔐 Admin e Segurança',
        sectionChat: '💬 Chat e Comunicação',
        sectionGameplay: '🎮 Opções de Jogo',
        ...
        // Section titles (Game.ini)
        sectionGameTaming: '🦖 Configurações de Domesticação',
        sectionGamePlayer: '🧑 Jogador e Progressão',
        sectionGameTribe: '👥 Configurações de Tribo',
        sectionGameCrafting: '🔨 Fabricação e Engramas',
        sectionGameLoot: '🎁 Loot e Recursos',
        sectionGameStructures: '🏠 Estruturas e Construção',
        sectionGameTurrets: '🔫 Torretas e Geradores',
        sectionGamePvP: '⚔️ Configurações PvP',
        sectionGameGenesis: '🌐 Específico de Genesis',
        sectionGameEnvironment: '🌡️ Ambiente e Mundo',
        sectionGameAdvanced: '⚙️ Configuração Avançada',
    ...
    ru: {
        ...
        // Section titles (GameUserSettings.ini)
        sectionBasic: '🖥️ Базовые Настройки Сервера',
        sectionAdmin: '🔐 Админ и Безопасность',
        sectionChat: '💬 Чат и Коммуникация',
        sectionGameplay: '🎮 Игровые Опции',
        ...
        sectionRagnarok: '🌋 Специфичное для Ragnarok',
        sectionValguero: '🏔️ Специфичное для Valguero',
        sectionFjordur: '❄️ Специфичное для Fjordur',
        sectionGenesis: '🌐 Специфичное для Genesis',
        sectionAberration: '🌌 Специфичное для Aberration',
        sectionExtinction: '🌍 Специфичное для Extinction',
        sectionLostColony: '🚀 Специфичное для Lost Colony',
        
        // Section titles (Lost Colony subsections)
        sectionLCBunker: '🏰 Tek Бункер',
        sectionLCCryoHospital: '❄️ CryoHospital',
        sectionLCBloodforge: '🩸 Bloodforge',
        sectionLCOutpost: '🏕️ Аванпост',
        sectionLCCreatures: '🦎 Существа',
        
        // Section titles (Game.ini)
        sectionGameTaming: '🦖 Настройки Приручения',
        sectionGamePlayer: '🧑 Игрок и Прокачка',
        sectionGameTribe: '👥 Настройки Племени',
        sectionGameCrafting: '🔨 Крафт и Энграмы',
        sectionGameLoot: '🎁 Добыча и Ресурсы',
        sectionGameStructures: '🏠 Структуры и Строительство',
        sectionGameTurrets: '🔫 Турели и Генераторы',
        sectionGamePvP: '⚔️ Настройки PvP',
        sectionGameGenesis: '🌐 Специфичное для Genesis',
        sectionGameEnvironment: '🌡️ Окружение и Мир',
        sectionGameAdvanced: '⚙️ Расширенная Конфигурация',
    ...
    zh: {
        ...
        // Section titles (GameUserSettings.ini)
        sectionBasic: '🖥️ 基本服务器设置',
        sectionAdmin: '🔐 管理员与安全',
        sectionChat: '💬 聊天与通信',
        sectionGameplay: '🎮 游戏选项',
        sectionRates: '📈 倍率和乘数',
        sectionPlayer: '👤 玩家设置',
        sectionDino: '🦕 恐龙设置',
        ...
        sectionRagnarok: '🌋 仲夏夜梦专属',
        sectionValguero: '🏔️ 瓦尔盖罗专属',
        sectionFjordur: '❄️ 峯维尔专属',
        sectionGenesis: '🌐 创世纪专属',
        sectionAberration: '🌌 畸变专属',
        sectionExtinction: '🌍 灭绝专属',
        sectionLostColony: '🚀 失落殖民地专属',
        
        // Section titles (Lost Colony subsections)
        sectionLCBunker: '🏰 Tek 掩体',
        sectionLCCryoHospital: '❄️ 冷冻医院',
        sectionLCBloodforge: '🩸 血锻',
        sectionLCOutpost: '🏕️ 前哨站',
        sectionLCCreatures: '🦎 生物',
        
        // Section titles (Game.ini)
        sectionGameTaming: '🦖 驯服设置',
        sectionGamePlayer: '🧑 玩家与升级',
        sectionGameTribe: '👥 部落设置',
        sectionGameCrafting: '🔨 制作与印痕',
        sectionGameLoot: '🎁 战利品与资源',
        sectionGameStructures: '🏠 建筑与结构',
        sectionGameTurrets: '🔫 炮塔与发电机',
        sectionGamePvP: '⚔️ PvP设置',
        sectionGameGenesis: '🌐 创世纪专属',
        sectionGameEnvironment: '🌡️ 环境与世界',
        sectionGameAdvanced: '⚙️ 高级配置',
    ...
    ja: {
        ...
        // Section titles (GameUserSettings.ini)
        sectionBasic: '🖥️ 基本サーバー設定',
        sectionAdmin: '🔐 管理者とセキュリティ',
        sectionChat: '💬 チャットとコミュニケーション',
        sectionGameplay: '🎮 ゲームプレイオプション',
        sectionRates: '📈 レートと倍率',
        ...
        sectionRagnarok: '🌋 ラグナロク固有',
        sectionValguero: '🏔️ ヴァルゲロ固有',
        sectionFjordur: '❄️ フィヨルドゥル固有',
        sectionGenesis: '🌐 ジェネシス固有',
        sectionAberration: '🌌 アベレーション固有',
        sectionExtinction: '🌍 エクスティンクション固有',
        sectionLostColony: '🚀 ロストコロニー固有',
        
        // Section titles (Lost Colony subsections)
        sectionLCBunker: '🏰 Tek バンカー',
        sectionLCCryoHospital: '❄️ クライオホスピタル',
        sectionLCBloodforge: '🩸 ブラッドフォージ',
        sectionLCOutpost: '🏕️ アウトポスト',
        sectionLCCreatures: '🦎 クリーチャー',
        
        // Section titles (Game.ini)
        sectionGameTaming: '🦖 テイム設定',
        sectionGamePlayer: '🧑 プレイヤーとレベルアップ',
        sectionGameTribe: '👥 トライブ設定',
        sectionGameCrafting: '🔨 クラフトとエングラム',
        sectionGameLoot: '🎁 ルートとリソース',
        sectionGameStructures: '🏠 建築と構造物',
        sectionGameTurrets: '🔫 タレットとジェネレーター',
        sectionGamePvP: '⚔️ PvP設定',
        sectionGameGenesis: '🌐 ジェネシス固有',
        sectionGameEnvironment: '🌡️ 環境とワールド',
        sectionGameAdvanced: '⚙️ 詳細設定',
    ...
    ko: {
        ...
        // Section titles (GameUserSettings.ini)
        sectionBasic: '🖥️ 기본 서버 설정',
        sectionAdmin: '🔐 관리자 및 보안',
        sectionChat: '💬 채팅 및 통신',
        sectionGameplay: '🎮 게임플레이 옵션',
        ...
        sectionRagnarok: '🌋 라그나로크 전용',
        sectionValguero: '🏔️ 발게로 전용',
        sectionFjordur: '❄️ 피오르두르 전용',
        sectionGenesis: '🌐 제네시스 전용',
        sectionAberration: '🌌 애버레이션 전용',
        sectionExtinction: '🌍 익스팅션 전용',
        sectionLostColony: '🚀 로스트 콜로니 전용',
        
        // Section titles (Lost Colony subsections)
        sectionLCBunker: '🏰 Tek 벙커',
        sectionLCCryoHospital: '❄️ 크라이오호스피탈',
        sectionLCBloodforge: '🩸 블러드포지',
        sectionLCOutpost: '🏕️ 전초기지',
        sectionLCCreatures: '🦎 생물',
        
        // Section titles (Game.ini)
        sectionGameTaming: '🦖 테이밍 설정',
        sectionGamePlayer: '🧑 플레이어 및 레벨업',
        sectionGameTribe: '👥 부족 설정',
        sectionGameCrafting: '🔨 제작 및 엔그램',
        sectionGameLoot: '🎁 루트 및 자원',
        sectionGameStructures: '🏠 건축 및 구조물',
        sectionGameTurrets: '🔫 터렛 및 발전기',
        sectionGamePvP: '⚔️ PvP 설정',
        sectionGameGenesis: '🌐 제네시스 전용',
        sectionGameEnvironment: '🌡️ 환경 및 월드',
        sectionGameAdvanced: '⚙️ 고급 구성',
